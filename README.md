...
### Other tools
utils.py is a set of auxilary methods meant to improve performance of the model integration. utils-checkpoint.py, model-checkpoint.py,  analytics-checkpoint.py as well as the associated .pyc files are tools used to imporve the performance of the code. 
